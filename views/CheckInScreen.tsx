...
const CheckOutScreen = ({ navigation }: { navigation: any }) => {
	...
	const validate = () => {
		if (amount < 1) {
			setShowError(true);
			setError("Unable to check in less than 1 product");
		}
			...
			<Content style={styles.content}>
				{
					...
					<Container style={{
						...
						<H1 style={styles.name}>Product check in</H1>
						<Text>Scan a product to check it in to your storage.</Text>
				...
				{barcode && product.length > 0 && (
					...
					>
						...
						<Button style={styles.create} onPress={() => validate()}><Text style={styles.createText}>Check in</Text></Button>
